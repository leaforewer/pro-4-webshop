    ...
    <div class="col-6 abc">
        <form action="./index.php?content=contact_script" method="post">
            ...
            <div class="form-group">
                ...
                <select id="subject" name="subject" style="padding-left: 30px; background-color: black; color: whitesmoke; padding-top: 2px; padding-bottom: 2px;">
            ...
            <small id="Help" class="form-text" style="color: black;">*Schrijf hier uw opmerkingen</small>
        </div>
